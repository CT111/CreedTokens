...
static const unsigned int MAX_BLOCK_SIZE = 7133133;
...
static const int64_t MAX_MONEY = 125000000 * COIN; // 125 Million
...
static const int64_t COIN_YEAR_REWARD1 = 1 * CENT; // 
static const int64_t COIN_REWARD1 = 20 * COIN; //
